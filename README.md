...
See [LICENSE](LICENSE) and [Descargo_Responsabilidad_y_EULA.md](Descargo_Responsabilidad_y_EULA.md) for the full Disclaimer of warranty and Terms of Use (EULA).
...
> Mauricio Javier Victoria Niño. *Tanque.NSR10: automated analysis and design of rectangular reinforced-concrete tanks under NSR-10, ACI 350.3 and the PCA manual.* Software companion to a preprint on **engrXiv** (2026). Repository: https://github.com/MauricioVictoriaN/Tanque.NSR10 — DOI to be assigned.
