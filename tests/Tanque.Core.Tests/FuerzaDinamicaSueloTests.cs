...
/// Tabla 39 del ejercicio 2 de la referencia. Igual que en <see cref="PresionesLateralesTests"/>, Ka
/// (y por tanto Keq/Qae, que dependen de él) se compara contra el valor de Rankine CORREGIDO
/// (observación 1), no contra el publicado -- ver FuerzaDinamicaSuelo.cs para el detalle completo.
/// θ, ψ y Kae no dependen de Ka y sí se comparan directamente contra la referencia.
/// </summary>
public class FuerzaDinamicaSueloTests
{
    ...
    public void Ejercicio2_CoincideConTabla39_SalvoKaCorregido()
    {
        ...
        // (observación 1). Valores correctos con Rankine (φ=28°): Ka≈0.36095, Keq=Kae-Ka≈0.05835,
