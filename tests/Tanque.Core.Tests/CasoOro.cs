...
/// propósito: cada JSON contiene el referencia autoritativa única completo de un ejercicio (geometría, cargas,
...
public sealed class CasoOro
{
    ...
    /// -- el valor original estaba transcrito de la Tabla 14 de la referencia sin verificación
    /// independiente y no coincidía con la fórmula confirmada por IL. Ver el campo
    /// "_correccion_esta_sesion" dentro del propio JSON y la hoja de seguimiento del proyecto.
    /// </summary>
