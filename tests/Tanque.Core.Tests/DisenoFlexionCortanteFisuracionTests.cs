...
/// las Tablas 71, 74 y 75 del ejercicio 2 de la referencia. A diferencia de los demás módulos, este
...
public class DisenoFlexionCortanteFisuracionTests
{
    ...
    {
        // CORREGIDO año de revisión (segunda ronda de auditoría externa, observación O1): esta prueba
        ...
        // hubiera hecho fallar "dotnet test". Este es el mismo observación, en un artefacto distinto
        ...
        // demostró ser sensible a errores de transcripción -- ver el observación del factor d²
        // documentado en el docstring de la clase, y el propio observación de signo).
    ...
    // Verificación INDEPENDIENTE (segunda ronda de auditoría externa, año de revisión, recomendación
    ...
    {
        // NSR-10 C.23-C.10.6.4.1 (cruce año de revisión): fs,max = clamp(fórmula, piso 140/170, tope 250).
