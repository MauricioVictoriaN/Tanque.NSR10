...
/// coeficientes del manual, usadas solo como referencia autoritativa única histórico (confirmado por doble lectura).
/// Donde la referencia diverge del manual (celda Cmx[5,3] en r=1.0), Tanque.Core sigue al MANUAL. El
/// lookup se verifica con r crudo, INDEPENDIENTE de la luz eje a eje (corrección año de revisión).
/// Cubre: coincidencia celda a celda contra el manual PCA, interpolación/rango tabulado, el
/// discriminador del observación 12 (carga de cubierta) y el método RedondearSuperior del nota de diseño v2.
/// </summary>
public class PlacasRectangularesTests
{
    ...
    public void Ejercicio1_PlacaFondo_r1_Las144CeldasDeMomentosCoincidenConManualPCA_Caso10()
    {
        ...
        // La referencia transcribe estos mismos coeficientes; la Única celda divergente de las 144
    ...
    [Fact]
    public void CargaDisenoCubierta_Observación12_Corregido()
    {
