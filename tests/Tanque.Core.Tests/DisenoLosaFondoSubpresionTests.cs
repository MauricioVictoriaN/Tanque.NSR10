...
public class DisenoLosaFondoSubpresionTests
{
    ...
    {
        // Cruce normativo C.23-C.7.12.2.1 (año de revisión): la cuantía mínima de retracción/temperatura
        ...
        // Notas opcionales C.23-C.7.12.2.1 (directiva año de revisión): la cara INFERIOR (contra el suelo)
    ...
    {
        // Observación del usuario (año de revisión): la sección "DISEÑO FINAL DE LA LOSA DE FONDO" no
