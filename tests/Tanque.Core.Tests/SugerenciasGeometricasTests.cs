...
/// <summary>
/// Pruebas de las sugerencias geométricas (nota de diseño v3, observación de UX confirmado por el usuario
/// año de revisión): cuando r cae fuera de [0.5, 4], las envolturas específicas lanzan
...
public class SugerenciasGeometricasTests
{
    ...
    {
        // B=2, L=5 -> r=B/L=0.4 <0.5 (el caso real reportado por el usuario, año de revisión)
