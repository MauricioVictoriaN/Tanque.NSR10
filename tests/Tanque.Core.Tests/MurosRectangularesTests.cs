...
/// de la referencia NO son la referencia numérica: son la transcripción de la referencia de esos mismos
/// coeficientes del manual, usadas aquí solo como un referencia autoritativa única histórico de conveniencia (confirmado
/// por doble lectura). Donde la referencia diverge del manual (celda My[7,3] de su "Tabla 21"),
/// Tanque.Core sigue al MANUAL y la prueba lo declara explícitamente. El lookup se verifica con r
/// crudo (r=b/a), INDEPENDIENTE de la luz eje a eje (corrección de flexión año de revisión), por lo que
...
public class MurosRectangularesTests
{
    ...
    public void Ejercicio1_r1_5_CortanteCoincideConManualPCA_Caso3_AmbasCondiciones()
    {
        ...
        // Condición 2 (exterior/suelo): el Ka CORREGIDO (observación 1) debe dar un valor distinto del
        // publicado por la referencia (23.44 kN, calculado con el Ka incorrecto 0.254366).
        ...
        AssertTol("V fondo cond 2 con Ka incorrecto (observación 1)", r2ConBug.VBottomKNm, 23.44, 0.05);
    }
    ...
    public void Ejercicio1_r1_5_Las66CeldasDeMomentosCoincidenConManualPCA_Caso3()
    {
        ...
        // La referencia transcribe estos mismos coeficientes; su "Tabla 21" tiene UN error de
    ...
    private static void VerificarCampoMuro(string nombre, double[,] campo, JsonNode tablaJson, (int fila, int col)? excepcion)
    {
        ...
        for (var fila = 0; fila < 11; fila++)
        {
            ...
            for (var col = 0; col < 6; col++)
            {
                ...
                {
                    // Discrepancia aislada de TRANSCRIPCIÓN DE LA referencia (su "Tabla 21" publica 2.6
    ...
    public void Capitulo3_Rectangular_CoincideConTablaManual_Y_SimetriaDeEsquina()
    {
        ...
        // CONFIRMADA (transcripción manual + OCR + simetría de esquina, sesión año de revisión).
