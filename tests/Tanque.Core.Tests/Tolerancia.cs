...
/// de referencia (banco de pruebas en casos_prueba/, valores transcritos de la referencia fuente del
/// programa original). Ver la hoja de seguimiento del proyecto, pendiente "Definir la
/// política de tolerancia de pruebas".
///
/// Contexto: los resultados publicados en la referencia están redondeados -- casi siempre a 2
...
/// tablas de la referencia -- una diferencia de hasta una unidad en el último decimal publicado no
