...
/// dimensión de año de revisión (el líquido se modela con el CLARO INTERIOR, ACI 350.3 "inside
/// dimensions", no con la dimensión exterior de las Tablas 37/38 de la referencia), la verificación
...
public class FuerzaSismicaHidrodinamicaTests
{
    ...
    private static ParametrosEspectroDiseno EspectroDesde(CasoOro caso) => new(
        ...
        // de la propia referencia entre tablas (única categoría de uso en todo el proyecto), no del
    ...
    /// <summary>
    /// Observación 8 corregido: la protección contra presión convectiva negativa debe activarse en
    ...
    public void PresionConvectivaNegativa_SeCorrigeSimetricamenteEnAmbosMuros()
    {
        ...
        foreach (var muro in new[] { r.MuroLongitudinal, r.MuroTransversal })
        {
            ...
            Assert.True(muro.HcAlturaCentroideConvectivoM > (2.0 / 3.0) * geometria.HLAlturaLiquidoM,
                "La geometría de prueba no produce hc>(2/3)HL; ajustar para ejercitar el observación 8.");
