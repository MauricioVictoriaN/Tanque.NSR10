...
/// (donde el módulo no tiene observaciones y los valores publicados en casos_prueba/*.json son
/// referencia autoritativa única directo), este módulo corrige dos observaciones confirmados del programa original
/// (Ka: observación 1; distribución Ps_i: observación 9 -- ver PresionesLaterales.cs). Los campos
...
/// pruebas NO los usan como referencia autoritativa única para Ka/Ps2 -- se comparan contra el valor corregido,
...
/// valor publicado, porque Ph no depende de Ka y no está afectado por ningún observación.
/// </summary>
public class PresionesLateralesTests
{
    ...
    public void Ejercicio1_Phi32Grados_KaYPs2CoincidenConRankineCorregido_PhCoincideConPublicado()
    {
        ...
        // Ph: no depende de Ka, no tiene observación abierto -> se compara contra el valor publicado.
        ...
        // denominador, observación 1). El valor correcto de Rankine para φ=32° es Ka=(1-sen32°)/(1+sen32°)
    ...
    public void Ejercicio2_Phi28Grados_KaYPs2CoincidenConRankineCorregido_PhUsaHL3mConsistente()
    {
        ...
        // "Ph_ADVERTENCIA" en el propio JSON). Se usa como referencia autoritativa única el campo
        ...
        // Igual que en ejercicio_1: el JSON publica Ka/Ps2 con la fórmula original (observación 1).
