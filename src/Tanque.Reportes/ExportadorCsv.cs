...
/// <summary>
/// Fase4 del frente de interfaz (año de revisión) -- exportación de grillas/resultados a CSV para
/// análisis en hojas de cálculo (ítem 2 del nota de diseño Fase4). Produce UN único archivo CSV en
