...
/// nota de diseño v2, interfaz/reportes (año de revisión): las grillas completas SÍ están disponibles bajo
...
/// <c>Tanque.Reportes</c> -- ahora 100% verificable en el el entorno de desarrollo. Se agregó
...
public static class ReporteResultados
{
    ...
    // nota de diseño v2, interfaz/reportes (año de revisión): etiquetas de posición para las grillas PCA/Marcus
    ...
    /// <summary>
    /// nota de diseño v2, interfaz/reportes (año de revisión): imprime un campo completo (6×6 de placa u 11×6
    ...
    /// <summary>nota de diseño v2, ítem 7 (año de revisión): NSR-10 C.23-C.14.6.</summary>
    ...
    /// <summary>
    /// nota de diseño v2, ítem 2/6 (año de revisión): ACI 350.4R-04 §3.1.2, solo TipoTanque.EnterradoConNivelFreatico.
    ...
    /// <summary>
    /// nota de diseño v2, punto 3 (año de revisión): diseño local de la losa de fondo bajo subpresión de agua
    ...
    /// <summary>
    /// nota de diseño v2, punto 3, ampliado (año de revisión): diseño final de la losa de fondo, envolviendo el
    ...
    /// <summary>
    /// Comentario de arquitectura (año de revisión): reemplaza la construcción del reporte completo que antes
    ...
    /// módulos directamente en el code-behind de la UI (observaciones H1/H3 del informe de auditoría
    ...
    public static string GenerarReporte(ResultadoCalculoTanque r)
    {
        ...
        // Corrección (año de revisión, a pedido del usuario): los diagramas de momento/cortante de la losa
        ...
        {
            // Corrección (año de revisión, a raíz de reporte del usuario): aviso explícito de la omisión,
            // nunca silenciosa.
    ...
    /// <summary>
    /// nota de diseño v3, Fase B (año de revisión): una sección con nombre de grupo, para presentar el reporte
    ...
    /// <summary>
    /// nota de diseño v3, Fase B (año de revisión, decidida por el usuario): reorganiza "Datos de entrada" y
    ...
    /// explícito de las grillas ASCII de momento. Fase3 del frente de interfaz (año de revisión): el
